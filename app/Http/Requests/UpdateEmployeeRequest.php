...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    {
        if ($this->has('folder_code') && !empty($this->folder_code)) {
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'folder_code'  => ['nullable', 'string', 'max:255', Rule::unique('folders', 'folder_code')->where(fn($q) => $q->where('is_available', 0))->ignore($folderId)],
