...
<div class="modal fade" id="createRackModal" tabindex="-1" aria-labelledby="createRackModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg border-0" style="border-radius: 16px; overflow: hidden;">
            <form method="POST" action="{{ route('settings.cabinets.store-rack') }}">
                @csrf
                <div class="modal-header border-bottom-0 pt-4 px-4 pb-0">
                    <h5 class="modal-title fw-bold" id="createRackModalLabel" style="color: #111827; letter-spacing: -0.025em; font-size: 1.25rem;">Add Rack</h5>
                ...
                <div class="modal-body px-4 pt-2">
                    <p class="text-muted mb-4" style="font-size: 0.9rem; line-height: 1.5;">Define a new rack inside a cabinet.</p>

                    <div class="row g-3 mb-3">
                        {{-- Cabinet Name --}}
                        <div class="col-md-6">
                            <label for="cabinet_name" class="form-label fw-semibold" style="font-size: 0.85rem; color: #374151;">
                        ...
                        {{-- Rack Code --}}
                        <div class="col-md-6">
                            <label for="rack_code" class="form-label fw-semibold" style="font-size: 0.85rem; color: #374151;">
...
@if($errors->any() && !old('_method'))
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var createModal = new bootstrap.Modal(document.getElementById('createRackModal'));
            createModal.show();
        });
    </script>
@endif
