<x-app-layout>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('settings.companies.create') }}" class="btn btn-brand d-inline-flex align-items-center gap-2">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    {{-- Toggle Active --}}
                                    <form method="POST"
                                          action="{{ route('settings.companies.toggle-active', $company) }}"
                                          x-data
                                          @submit.prevent="if(confirm('{{ $company->is_active ? 'Deactivate' : 'Reactivate' }} {{ addslashes($company->name) }}?')) $el.submit()">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit"
                                                class="btn-doc-action"
