...
<div class="modal fade" id="createDocumentTypeModal" tabindex="-1" aria-labelledby="createDocTypeLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow-lg border-0" style="border-radius: 16px; overflow: hidden;">
            <form method="POST" action="{{ route('settings.document-types.store') }}">
                @csrf
                <div class="modal-header border-bottom-0 pt-4 px-4 pb-0">
                    <h5 class="modal-title fw-bold" id="createDocTypeLabel" style="color: #111827; letter-spacing: -0.025em; font-size: 1.25rem;">Add Document Type</h5>
                ...
                <div class="modal-body px-4 pt-4">
                    <p class="text-muted mb-4" style="font-size: 0.9rem; line-height: 1.5;">Register a new classification type used to categorize uploaded documents.</p>
                    ...
                    <div class="row g-4">
                        ...
                        {{-- Department --}}
                        <div class="col-md-6">
                            <label for="department_id" class="form-label fw-semibold" style="font-size: 0.85rem; color: #374151;">
                        ...
                        {{-- Max Pages --}}
                        <div class="col-md-6">
                            <label for="max_pages" class="form-label fw-semibold" style="font-size: 0.85rem; color: #374151;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number"
                                       ...
                                       style="background-color: #f9fafb;">
                                @error('max_pages')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
...
@if($errors->any() && old('_method') !== 'PUT')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var createModal = new bootstrap.Modal(document.getElementById('createDocumentTypeModal'));
            createModal.show();
        });
    </script>
@endif
